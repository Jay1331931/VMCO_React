...
function CoolingPeriodEditor() {
    ...
    const fetchCoolingPeriods = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/cooling-period/pagination`, {
                params: {
                    page,
                    pageSize,
                    search: searchQuery,
    ...
    }, [API_BASE_URL, token, page, pageSize, searchQuery, activeCategory, filters]);
    ...
    const handleAddSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_BASE_URL}/cooling-period`, payload, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
                },
            ...
            if (response.data?.status?.toLowerCase() === "ok" || response.status === 201) {
    ...
    const handleDeleteClick = async (activeCategory) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.delete(`${API_BASE_URL}/cooling-period/delete/${activeCategory}`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    });
                    ...
                    if (response.data?.status?.toLowerCase() === "ok") {
                        Swal.fire("Deleted!", "Cooling periods have been deleted.", "success");
                        fetchCoolingPeriods();
                    }
                } catch (err) {
            ...
            <div className="orders-container">
                ...
                {showAddForm && (
                    <div style={{
                        ...
                        <h3 style={{ marginTop: 0 }}>{t("Add New Cooling Period")}</h3>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: "20px", alignItems: "end" }}>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setNewPeriod({ ...newPeriod, fromTime: e.target.value })}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setNewPeriod({ ...newPeriod, toTime: e.target.value })}
                                    style={{ width: "100%", padding: "8px", borderRadius: "4px", border: "1px solid #ced4da" }}
                                />
                            </div>
                ...
                {showEditModal && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <h3 style={{ marginTop: 0 }}>{t("Edit Cooling Period")}</h3>
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setEditData({ ...editData, fromTime: e.target.value })}
                                    style={{ width: "100%", padding: "8px", borderRadius: "4px", border: "1px solid #ced4da" }}
                                />
                            </div>
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setEditData({ ...editData, toTime: e.target.value })}
                                    style={{ width: "100%", padding: "8px", borderRadius: "4px", border: "1px solid #ced4da" }}
                                />
                            </div>
