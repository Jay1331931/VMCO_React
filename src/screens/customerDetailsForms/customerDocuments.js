...
export function getDocumentsForm(t) {
  return {
    'Documents': [
      ...
      { type: 'document', name: 'commercialRegistration', label: t('Copy of Commercial Registration'), required: true },
      ...
      { type: 'document', name: 'bankDetails', label: t('Bank details on company letterhead'), required: true },
      {
        type: 'multiDocument',
