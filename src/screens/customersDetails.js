  ...
  try {
   const customer = {
    "request": {
        "dataAreaId": "USMF",
        "id": 9,
        "companyNameEn": "cust 9",
        "companyNameAr": "العميل 9",
        "companyType": "",
        "crNumber": "",
        "vatNumber": "",
        "baladeshLicenseNumber": "983773",
        "governmentRegistrationNumber": "",
        "typeOfBusiness": "",
        "deliveryLocations": "",
        "companyLogo": "",
        "brandLogo": "",
        "brandNameEn": "Robot building",
        "brandNameAr": "",
        "buildingName": "Opp Jada-e-maiwand Aryana Plaza, 4th Floor,Kabul",
        "street": "4th Street",
        "city": "Jalalabad",
        "region": "",
        "geolocation": "",
        "bankName": "HSBC",
        "bankAccountNumber": "787654345678876",
        "iban": "IBAN08765",
        "crCertificate": "",
        "vatCertificate": "",
        "nationalId": "",
        ...
        "contactDetailsList": [
            {
                ...
                "contactDescription": "Ahmed Ali",
                "contactPhoneNo": "+966501234567",
                "contactEmailAddress": "ahmed.ali@alkhaleej.com"
            },
            {
                "contactType": "operations",
                "designation": "Operations Manager",
                "contactDescription": "Fatima Hassan",
                "contactPhoneNo": "+966501234568",
                "contactEmailAddress": "fatima.h@alkhaleej.com"
            },
            {
                "contactType": "finance",
                "designation": "Finance Director",
                "contactDescription": "Mohammed Said",
                "contactPhoneNo": "+966501234569",
                "contactEmailAddress": "Mohammed.s@alkhaleej.com"
            },
            {
                "contactType": "purchasing",
                "designation": "Purchase Manager",
                "contactDescription": "Sara Ahmed",
                "contactPhoneNo": "+966501234570",
                "contactEmailAddress": "sara.a@alkhaleej.com"
            }
        ]
    }
}
    const { data } = await axios.post("http://localhost:3000/integration/api/createCustomerMaster", customer
...
const handleBranch = async () => {  
  try {
    ...
    "request": {
        "dataAreaId": "USMF",
        "id": 133,
        "customerId": 12,//Parent Customer Portal Custer Id
        "erpCustomerId": "000037",//Parent Customer ERP Custer Id
        "branchNameEn": "test company ltd13",
        "branchNameAr": "م / ق مشفق راشد المحدودة",
        "city": "Kabul",
        "locationType": "",
        "locationTypeOther": "",
        "geolocation": "",
        "approvalRequiredForOrdering": "",
        "assignedTo": "",
        "hours": "",
        "branchStatus": "",
        "isDeliveryChargesApplicable": "",
        "deleted": "",
        "buildingName": "Opp Jada-e-maiwand Aryana Plaza, 4th Floor,Jalalabad",
        "street": "5th Street",
        "contactDetailsList": [
            {
                "contactType": "primary",
                "designation": "Branch Manager",
                "contactDescription": "Khalid Omar",
                "contactPhoneNo": "+966501234571",
                "contactEmailAddress": "khalid.o@alkhaleej.com"
            },
            {
                "contactType": "secondary",
                "designation": "Assistant Manager",
                "contactDescription": "Noor Ali",
                "contactPhoneNo": "966501234572",
                "contactEmailAddress": "noor.a@alkhaleej.com"
            },
            {
                "contactType": "supervisor",
                "designation": "Manager",
                "contactDescription": "Hassan Mohammed",
                "contactPhoneNo": "966501234573",
                "contactEmailAddress": "hassan.m@alkhaleej.com'"
            }
        ]
    }}
    const { data } = await axios.post("http://localhost:3000/integration/api/CreateCustBranchMaster", branchesData)
    ...
    if (data.success === true) {
      Swal.fire({
        icon: 'success',
        title: t('Success'),
        text: t('Customer Branch created successfully!'),
        confirmButtonText: t('OK')
      }); 
    }
  } catch (error) {
    console.error('Error during Create customer Branch:', error);
              ...
              {activeTab === 'Products & MoQ' ? (
                ...
                <div className="customer-onboarding-form-grid" ref={contentRef}>
                  ...
                  <div className="form-main-header">
                    ...
                    <button className='create-customer-btn' onClick={handleCustomer}>Create Customer</button>
                    <button className='create-customer-btn' onClick={handleBranch}> Create Branch</button>
                     <button className='create-customer-btn' onClick={handleCustomer}> Pricing Policy</button>
                    </div>
