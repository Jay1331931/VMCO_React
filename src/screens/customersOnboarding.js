            ...
            `${API_BASE_URL}/auth/registration/customer`,
            {
              ...
              body: JSON.stringify({
                ...
                assignedToEntityWise: {
                  [constants.ENTITY.VMCO]: constants.ENTITY.VMCO.toLowerCase() === leadData?.primaryBusinessUnit.toLowerCase() ? leadData.employeeId : areaSalesManager,
                  [constants.ENTITY.SHC]: constants.ENTITY.SHC.toLowerCase() === leadData?.primaryBusinessUnit.toLowerCase()? leadData.employeeId : areaSalesManager,
                  [constants.ENTITY.DAR]: constants.ENTITY.DAR.toLowerCase() === leadData?.primaryBusinessUnit.toLowerCase()? leadData.employeeId : areaSalesManager,
                  [constants.ENTITY.NAQI]: constants.ENTITY.NAQI.toLowerCase() === leadData?.primaryBusinessUnit.toLowerCase()? leadData.employeeId : areaSalesManager,
                  [constants.ENTITY.GMTC]: constants.ENTITY.GMTC.toLowerCase() === leadData?.primaryBusinessUnit.toLowerCase()? leadData.employeeId : areaSalesManager,
                },
              }),
