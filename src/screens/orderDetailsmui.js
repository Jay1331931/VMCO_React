...
import OrderDetailsCommentPopup from '../components/OrderDetailsCommentPopup';
      ...
      const updatePromises = formData.products.map(async (product, index) => {
        ...
        if (response.ok) {
          ...
          if (result.status === "Ok" && result.data) {
            ...
            // Update product in array - RESET lineDiscount to 0.00
