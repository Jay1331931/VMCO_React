        ...
        <div className='support-details-actions'>
          {isEditing ? (
            <>
              ...
              <button className='support-action-btn cancel' onClick={handleCancel}>
                {t("Cancel")}
              </button>
            </>
          ) : (
            <>
              <button className='support-action-btn edit' onClick={handleCancel}>
                {t("Edit")}
              </button>
              <button className='support-action-btn differ'>{t("Cancel")}</button>
            </>
          )}
        </div>
      </div>
