...
export const getTimeOnly = (dateInput, zone = "Asia/Riyadh", format = "HH:mm:ss") => {
  if (!dateInput) return '';
  ...
  try {
    ...
    else if (dateInput.includes('-') && dateInput.includes(':') && !dateInput.includes(',')) {
...
export const getDateOnly = (dateInput, zone = "Asia/Riyadh", format = "DD/MM/YYYY") => {
